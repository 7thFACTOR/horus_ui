...
namespace hui
{
void checkErrorGL(const std::string& where)
{
...
void OpenGLGraphicsProvider::deleteTextureArray(TextureArray* texture)
{
	delete texture;
}
...
void OpenGLGraphicsProvider::deleteVertexBuffer(VertexBuffer* vb)
{
	delete vb;
}
