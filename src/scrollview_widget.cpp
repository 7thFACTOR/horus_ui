...
Point endScrollView()
{
	...
	f32 scrollContentWidth = scrollViewInfo.maxContentX - prevPenPos.x + internalPaddingX;
	f32 scrollAmount = 0;
	f32 scrollAmountX = 0;
	...
	if (ctx->position.y + scrollAmount + internalPaddingY < rect.y + effectiveViewHeight)
	{
