...
struct UtfCppProvider : UtfProvider
{
	...
	bool utf16To8(const wchar_t* utf16Str, char** outUtf8Str) override;
	bool utf32To8NoAlloc(const Utf32String& utf32Str, const char* outUtf8Str, size_t maxUtf8StrLen) override;
	bool utf32To8NoAlloc(const u32* utf32Str, size_t utf32StrSize, const char* outUtf8Str, size_t maxOutUtf8StrSize) override;
