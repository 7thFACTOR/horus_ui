...
- Widgets: text input (with hint text), button, icon button, dropdown, menu, context menu, tab, panel, radio, check, slider, etc.
- MegaWidgets: color picker, XYZ/XY editor
